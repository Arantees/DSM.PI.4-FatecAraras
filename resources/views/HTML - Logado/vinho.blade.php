...
<body>
    <nav class="navbar">
        <a class="navbar-brand" href="#">K-DRINKS</a>
        <div>
            <a href="#">Suporte</a>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="image-container">
                        <img src="../Imagens/tela de vinhos/vinho tinto.png" class="card-img-top" alt="Vinho tinto">
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="image-container">
                        <img src="../Imagens/tela de vinhos/Vinho branco.png" class="card-img-top" alt="Vinho branco">
                        <div class="form-check">
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="image-container">
                        <img src="../Imagens/tela de vinhos/Espumante.png" class="card-img-top" alt="Espumante">
                        <div class="form-check">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Espumante</h5>
                        <p class="card-text">250ml</p>
                        <p class="card-text">A crisp and refreshing lager with a smooth finish and hints of malt.</p>
                    </div>
                </div>
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="image-container">
                        <img src="../Imagens/tela de vinhos/Vinho licoroso.png" class="card-img-top" alt="Vinho licoroso">
                        <div class="form-check">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Vinho licoroso</h5>
                        <p class="card-text">250ml</p>
                        <p class="card-text">A crisp and refreshing lager with a smooth finish and hints of malt.</p>
                    </div>
                </div>
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="image-container">
                        <img src="../Imagens/tela de vinhos/Vinho seco.png" class="card-img-top" alt="Vinho seco">
                        <div class="form-check">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Vinho seco</h5>
                        <p class="card-text">250ml</p>
                        <p class="card-text">A crisp and refreshing lager with a smooth finish and hints of malt.</p>
                    </div>
                </div>
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="image-container">
                        <img src="../Imagens/tela de vinhos/Vinho laranja.png" class="card-img-top" alt="Vinho laranja">
                        <div class="form-check">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Vinho laranja</h5>
                        <p class="card-text">250ml</p>
                        <p class="card-text">A crisp and refreshing lager with a smooth finish and hints of malt.</p>
                    </div>
                </div>
