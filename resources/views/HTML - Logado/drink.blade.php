    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="image-container">
                        <img src="../Imagens/tela de drinks/caipirinha.png" class="card-img-top" alt="Vinho tinto">
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="image-container">
                        <img src="../Imagens/tela de drinks/cuba libre.png" class="card-img-top" alt="Vinho branco">
                        <div class="form-check">
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="image-container">
                        <img src="../Imagens/tela de drinks/dry martini.png" class="card-img-top" alt="Espumante">
                        <div class="form-check">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Dry martini</h5>
                        <p class="card-text">250ml</p>
                        <p class="card-text">A crisp and refreshing lager with a smooth finish and hints of malt.</p>
                    </div>
                </div>
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="image-container">
                        <img src="../Imagens/tela de drinks/margarita.png" class="card-img-top" alt="Vinho licoroso">
                        <div class="form-check">
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="image-container">
                        <img src="../Imagens/tela de drinks/mojito.png" class="card-img-top" alt="Vinho seco">
                        <div class="form-check">
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="image-container">
                        <img src="../Imagens/tela de drinks/pina colada.png" class="card-img-top" alt="Vinho laranja">
                        <div class="form-check">
